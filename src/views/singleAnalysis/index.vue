<template>
  <div class="app-container">
    ...
    <div id="tess1" style="display:block">
      <img src="./csdc.png" style="width:100%;height:500px">
    </div>
    <el-card v-show="visible" class="box-card">
      ...
      <el-table :data="analysisResult" height="290" style="width: 100%">
        <el-table-column prop="aspect" label="属性" width="180" />
        <el-table-column prop="opinions" label="观点" />
        <el-table-column prop="sentiment" label="情感倾向" width="180" />
      </el-table>
    </el-card>
  </div>
</template>
